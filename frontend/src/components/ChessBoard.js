...
function Piece({ piece, square, onMove }) {
    ...
    const renderPiece = () => {
        ...
        try {
            switch (piece) {
                case 'r': return <img src="/assets/images/Black_rook.png" alt="black rook" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'n': return <img src="/assets/images/Black_knight.png" alt="black knight" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'b': return <img src="/assets/images/Black_bishop.png" alt="black bishop" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'q': return <img src="/assets/images/Black_queen.png" alt="black queen" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'k': return <img src="/assets/images/Black_king.png" alt="black king" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'p': return <img src="/assets/images/Black_pawn.png" alt="black pawn" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'R': return <img src="/assets/images/White_rook.png" alt="white rook" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'N': return <img src="/assets/images/White_knight.png" alt="white knight" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'B': return <img src="/assets/images/White_bishop.png" alt="white bishop" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'Q': return <img src="/assets/images/White_queen.png" alt="white queen" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'K': return <img src="/assets/images/White_king.png" alt="white king" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                case 'P': return <img src="/assets/images/White_pawn.png" alt="white pawn" style={imgStyle} onError={handleImageError} onLoad={handleImageLoad} />;
                default: return '';
            }
        } catch (error) {
